...
namespace TrashCollector.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CustomerId,FirstName,LastName,Address,IdentityUserId")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CustomerId,FirstName,LastName,Address,IdentityUserId","PickUpDays")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
